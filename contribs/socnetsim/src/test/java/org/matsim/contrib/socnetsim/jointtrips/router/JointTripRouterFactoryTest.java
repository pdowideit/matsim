...
public class JointTripRouterFactoryTest {
	...
	private static Scenario createScenario() {
		...
		Leg dLeg = PopulationUtils.createAndAddLeg( plan, JointActingTypes.DRIVER, JointActingTypes.DRIVER );
		...
		Leg pLeg = PopulationUtils.createAndAddLeg( plan, JointActingTypes.PASSENGER, JointActingTypes.PASSENGER );
