...
public class RunPSimTest {
	...
	public void testB() {
		...
		if ((psimscore - qsimscore) / qsimscore < 0.005)
			Assert.fail("Usually RunPSim outperforms default Controler on this test for executed score by a margin > 0.5%; something changed.");
	}
